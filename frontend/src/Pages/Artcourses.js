      ...
      <div className="container mt-5 mb-5">
        ...
        <div className="container mb-5 flip-card">
          <div className="row g-0 " style={{ height: "40vh" }}>
            <div className="col-md-4 border rounded">
              <img
                src={img7}
                className="img-fluid rounded-start kirly"
                alt="kids"
              />
            </div>
            <div className="col-md-6" style={{ backgroundColor: "#fff2f7" }}>
              <div className="card-body">
                <h5 className="card-title" style={{ color: "#168eca" }}>
                  kids (From 4 to 6 years old)
                </h5>
                <p className="card-text desc">
                  The drawing course for this age is designed to let the kids
                  unleash their imagination during the painting In addition to
                  learning the basic geometric shapes in an indirect way
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mb-5 flip-card">
          <div className="row g-0 ">
            ...
            >
              <div className="card-body">
                <h5 className="card-title" style={{ color: "#168eca" }}>
                  middle age (From 7 to 9 years old)
                </h5>
                <p className="card-text desc">
                  At this age stage, the kids start to learn more about the
                  basic proportions of the human body and faces. Also, they
                  train about the famous artists.
                </p>
              </div>
            </div>
            <div className="col-md-4 border rounded ">
        ...
        <div className="container mb-5 flip-card">
          <div className="row g-0 ">
            <div className="col-md-4 border rounded">
              <img
                src="https://media.istockphoto.com/photos/happy-latin-female-working-on-a-painting-picture-id1144643775?b=1&k=20&m=1144643775&s=170667a&w=0&h=4nagCwIv30VVCMonQg2KTHiL5SxeENGzUzbpzX2VR4M="
            ...
            <div className="col-md-6" style={{ backgroundColor: "#fff2f7" }}>
              <div className="card-body">
                <h5 className="card-title" style={{ color: "#168eca" }}>
                  Elderly (From 9 years old and above)
                </h5>
                <p className="card-text desc">
                  The teens start to use different materials and colors, to
                  produce a painting integrates elements
                </p>
              </div>
            </div>
          </div>

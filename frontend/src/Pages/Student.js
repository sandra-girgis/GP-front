      ...
      <>
        ...
        <div className="col-12 row">
          <div className="col-md-6">
            <h3 className="mt-4 fs-md-5 mb-5 ins_name ">{instructor.username}</h3>
          ...
          <div className=" col-md-6 ">
            ...
            <Card className="ms-3 mt-4" style={{ width: "30rem" }}>
              <Card.Body>
                ...
                <Card.Text className="text-muted">From : {i.from}</Card.Text>
                <Card.Text className="text-muted">To : {i.to}</Card.Text>
                <Card.Text className="text-muted">Day : {i.day}</Card.Text>
                <Card.Text className="text-muted">Payment Status : {i.PaymentStatus ? "Paid" : "Not Paid"}</Card.Text>
                <Card.Text className="text-muted">Category : {i.CategoryName}</Card.Text>
              </Card.Body>
            </Card>
            </>
            ))}
